...
export function GuitarTabForm() {
  ...
  const [valueEm, setValueEm] = useState(""); //<-- To control user input by expression regular.
  const [valueB, setValueB] = useState(""); //<-- To control user input by expression regular.
  ...
  return (
    <>
      <form
        ...
        className="from-create-tab flex gap-2 my-5 justify-center"
      >
        <input
          placeholder="e"
          type="text"
